> **文档状态**：审查结论与实施计划（**P0/P1/P2 已实施**，2026-08-27，198 单测全绿；P3 两项暂缓）
>
> **实施情况**：缺陷 1/2/3 已修（逐 issue 裁决 / all_skipped 门禁 / claim 校验）；
> 计划 1.1 1.2 2.2 2.3 2.4 3.1 3.2 4.1 4.2 5.2 5.3 5.4 6.1 6.2 6.3 6.4 已落地；
> P3（1.3 变异自检、4.3 CodeGraph 需求映射）暂缓。3.2 的 base 对照经
> `[coverage] bug_base_compare` 开关启用（默认关：每次失败批次多一次完整构建）。
>
